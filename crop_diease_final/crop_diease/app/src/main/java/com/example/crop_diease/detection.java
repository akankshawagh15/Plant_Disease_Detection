...
public class detection extends AppCompatActivity {
    ...
    private void notification(String data) {
        ...
        smsManager1.sendTextMessage("+919307857692", null, data, null, null);

        SmsManager smsManager2 = SmsManager.getDefault();
        smsManager2.sendTextMessage("919022640157", null, data, null, null);

        SmsManager smsManager3 = SmsManager.getDefault();
         smsManager3.sendTextMessage("8830786789", null, data, null, null);
//
//        SmsManager smsManager4 = SmsManager.getDefault();
//        smsManager4.sendTextMessage("phoneNo", null, data, null, null);
